        ...
        <div className="col-12">
          <DashCard>
            ...
            <div className="row g-3">
              ...
              <div className="col-md-3">
                <Link to="/superadmin-requests" className={`btn ${bloodRequests.filter(req => req.status === "forwarded").length > 0 ? "btn-primary" : "btn-outline-info"} w-100`}>
        ...
        <div className="col-12">
          <DashCard>
            <div className="d-flex justify-content-between align-items-center mb-3">
              ...
              <Link to="/superadmin-requests" className="btn btn-primary">
            ...
            {loadingRequests ? (
              ...
              <div className="alert alert-info">
                ...
                No forwarded blood requests found that require your attention.
              </div>
            ) : (
              <div>
                <div className="alert alert-warning mb-3">
                  <i className="fas fa-exclamation-triangle me-2"></i>
                  <strong>Attention Required:</strong> You have {bloodRequests.filter(req => req.status === "forwarded").length} forwarded blood requests that need your attention.
                </div>
                <div className="table-responsive">
                  ...
                  {bloodRequests.filter(req => req.status === "forwarded").length > 3 && (
                    <div className="text-center mt-3">
                      <Link to="/superadmin-requests" className="btn btn-primary">
                        View All {bloodRequests.filter(req => req.status === "forwarded").length} Forwarded Requests
                      </Link>
                    </div>
                  )}
                </div>
